...
namespace SeguraChain_Desktop_Wallet.InternalForm.SendTransaction
{
    public partial class ClassWalletSendTransactionConfirmationForm : Form
    {
        ...
        private void ClassWalletSendTransactionConfirmationForm_Load(object sender, EventArgs e)
        {
            ...
            labelSendTransactionAmountTotalToSend.Text = _walletSendTransactionConfirmationFormLanguage.LABEL_SEND_TRANSACTION_CONFIRMATION_AMOUNT_TO_SEND_TEXT + ClassTransactionUtility.GetFormattedAmountFromBigInteger(_sendTransactionTotalSend) + @" " + BlockchainSetting.CoinTickerName;
            ...
            labelSendTransactionConfirmationFeeToPay.Text = _walletSendTransactionConfirmationFormLanguage.LABEL_SEND_TRANSACTION_CONFIRMATION_FEE_TO_PAY_TEXT + ClassTransactionUtility.GetFormattedAmountFromBigInteger(_sendTransactionTotalFeeToPay) + @" " + BlockchainSetting.CoinTickerName;
            labelSendTransactionConfirmationTotalToSpend.Text = _walletSendTransactionConfirmationFormLanguage.LABEL_SEND_TRANSACTION_CONFIRMATION_TOTAL_TO_SPEND_TEXT + ClassTransactionUtility.GetFormattedAmountFromBigInteger(_sendTransactionTotalSend + _sendTransactionTotalFeeToPay) + @" " + BlockchainSetting.CoinTickerName;

dotnet publish SeguraChain-Peer\SeguraChain-Peer.csproj --configuration Debug --framework net9.0 --output Output\Node\Node\Linux\x64\Debug\Net9\ --runtime linux-x64 --verbosity quiet --self-contained true -p:PublishSingleFile=true

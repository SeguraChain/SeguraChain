...
dotnet publish SeguraChain-Peer\SeguraChain-Peer.csproj --configuration Release --framework net8.0 --output Output\Linux\x64\Remease\Net8\ --runtime linux-x64 --verbosity quiet --self-contained true -p:PublishSingleFile=true
dotnet publish SeguraChain-Peer\SeguraChain-Peer.csproj --configuration Release --framework net8.0 --output Output\Windows\x64\Remease\Net8\ --runtime win-x64 --verbosity quiet --self-contained true -p:PublishSingleFile=true

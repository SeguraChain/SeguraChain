            ...
            if (BlockchainMemoryManagement.Count > 0)
            {
                ...
                while (!cancel)
                {
                    ...
                    for (int k = 0; k < ClassBlockchainDatabaseDefaultSetting.MaxBlockTaskSave; k++)
                    {
                        ...
                        {
                            long blockHeight = totalBlockSaved + 1;
